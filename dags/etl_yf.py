...
with DAG(
    ...
    spark_etl_yFinance = SparkSubmitOperator(
        task_id="spark_etl_yFinance",
        application=f'{Variable.get("spark_scripts_dir")}/ETL_yFinance.py',
    ...
    get_process_date_task >> create_table >> clean_process_date >> spark_etl_yFinance >> send_email_task
